...
class Hexagon extends CI_Controller {
	...
	public function hexagon_demo(){
		...
		$this->load->view("hexagon-demo-proj/view_cbd_hexagon_header", $data);
		$this->load->view("view_cbd_navbar", $data);
		$this->load->view("hexagon-demo-proj/view_cbd_hexagon_home", $data);
