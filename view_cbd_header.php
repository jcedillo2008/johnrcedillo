...
<head>
    ...
    <style>
    .cbd #clock.dark .alarm{
    background:url('<?php echo base_url() ?>assets/img/digital-clock-proj/alarm_dark.jpg');
}
.cbd #clock.light .alarm{
    background:url('<?php echo base_url() ?>assets/img/digital-clock-proj/alarm_light.jpg');
}
    </style>
  </head>
